...
const StoryListItem = ({ index, key, userId, profileImage, profileName, time, duration, onFinish, onClosePress, stories, currentPage, onStorySeen, renderCloseComponent, loadedAnimationBarStyle, unloadedAnimationBarStyle, animationBarContainerStyle, storyUserContainerStyle, storyImageStyle, storyAvatarImageStyle, storyContainerStyle, storyVideoStyle, }) => {
    ...
    return (<react_native_swipe_gestures_1.default key={key} onSwipeUp={onSwipeUp} onSwipeDown={onSwipeDown} config={config} style={[styles.container, storyContainerStyle]}>
      <react_native_1.SafeAreaView>
        <react_native_1.View style={styles.backgroundContainer}>
          {content[current]?.isVideo ? (<react_native_video_1.default source={{
            ...
            }} style={[styles.video, storyVideoStyle]} controls={true} rate={1.0} volume={1.0} muted={false} resizeMode={'cover'} type={'m3u8'}/>) : (<react_native_1.Image onLoadEnd={() => start()} source={{ uri: content[current].story }} style={[styles.image, storyImageStyle]}/>)}
      ...
      <react_native_1.View style={styles.flexCol}>
        <react_native_1.View style={[styles.animationBarContainer, animationBarContainerStyle]}>
          {content.map((index, key) => {
            return (<react_native_1.View key={key} style={[styles.animationBackground, unloadedAnimationBarStyle]}>
        ...
        <react_native_1.View style={[styles.userContainer, storyUserContainerStyle]}>
          <react_native_1.View style={styles.flexRowCenter}>
